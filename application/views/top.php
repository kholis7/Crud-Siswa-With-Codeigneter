...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url() ?>assets/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SMK </b>YAPIIM</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url()?>Niomic/ubah_profile" class="btn btn-default btn-flat">Ganti Foto</a>
                </div>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MAIN NAVIGATION</li>
            <li><a href="<?php echo base_url() ?>Niomic"><i class="fa fa-users"></i> Data Pelajar</a></li>
        </li>
      </ul>
    </section>
    <!-- /.sidebar -->
